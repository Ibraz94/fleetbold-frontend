    ...
    return (
        <>
            <div id="introduction" className="mb-8">
                <p>
                    FleetBold is not just another web template—it's a meticulously
                    crafted masterpiece that stands out in a market flooded with
                    generic, poorly designed options. Every aspect of FleetBold, from
                ...
                <p>
                    ...
                    libraries, FleetBold features a comprehensive suite of
                ...
                <p>
                    FleetBold is equipped with advanced features like multi-language
                    ...
                    global platform or a niche application, FleetBold's versatility
                    has you covered.
                </p>
                <p>
                    Moreover, the included application examples are grounded in
                    real-world use cases, giving you practical, ready-to-use
                    solutions for your projects. With FleetBold, you're not just
            ...
            <div id="coreLibrary">
                ...
                <p>Here's a list of the core libraries we use in FleetBold</p>
